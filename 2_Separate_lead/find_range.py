...
def find_lead(img, loc, img_type, lead_idx):
    """
...
#            print(lead_range)
        ...
        #type2問題很大，各lead振幅及位置不固定，只能先用sample_image來建個大概
        elif img_type == 2:
            threshold = 60
            w = w-159
        ...
        #type3資料極度缺乏，各lead振幅及位置貌似不固定，只能先用sample_image來建個大概
        elif img_type == 3:
            threshold = 30
            #shift_w[第一排左邊, 第二排左邊, 第三排左邊, 第四排左邊, 邊線左邊]
        ...
        #type7雖有資料，但各lead振幅不確定，先用已知資料取範圍
        elif img_type == 7:
            threshold = 30
            w = w - 21
            #shift_w[第一排左邊, 第二排左邊, 第三排左邊, 第四排左邊, 邊線左邊]
        ...
        #type8資料極少，各lead振幅不確定，先用已知資料取範圍
        elif img_type == 8:
        ...
        #type9資料極度缺乏，各lead振幅及位置貌似不固定，只能先用sample_image來建個大概
        elif img_type == 9:
            threshold = 40
        ...
        #type10資料極少，各lead振幅不確定，先用已知資料取範圍
        elif img_type == 10:
